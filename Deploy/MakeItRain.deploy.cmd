...
set _DeploySetParametersFile=%RootPath%MakeItRain.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MakeItRain.zip" (
echo "%RootPath%MakeItRain.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%MakeItRain.deploy-readme.txt" (
...
start notepad "%RootPath%MakeItRain.deploy-readme.txt"
)
echo =========================================================
goto :eof
